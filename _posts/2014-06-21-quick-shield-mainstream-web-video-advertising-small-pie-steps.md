...
layout: post
link: >
  http://www.banpie.info/quick-shield-mainstream-web-video-advertising-small-pie-steps/
published: true
tags:
  - Chrome
categories:
...
<img class="alignnone size-full wp-image-696" src="http://www.banpie.info/wp-content/uploads/2018/11/0-21.jpg" width="900" height="450" alt="" />

## 3、尽享清爽的视频世界

点击在 Chrome 浏览器右上角的插件图标，你可以通过下图的菜单栏勾选，控制哪些网站需要去广告，哪些网站不需要。

<img class="alignnone size-full wp-image-697" src="http://www.banpie.info/wp-content/uploads/2018/11/0-22.jpg" width="900" height="506" alt="" />

## 4、更多：假如你也科学上网

如果你也使用 Goagent + Proxy Sharp 在翻墙，不用担心去广告插件会失效，点击「优酷去广告」插件图标，进入参数设置，根据下图配置后，将 Proxy Sharp 的代理模式切换为「自动模式」即可。

<img class="alignnone size-full wp-image-698" src="http://www.banpie.info/wp-content/uploads/2018/11/0-23.jpg" width="620" height="272" alt="" />
